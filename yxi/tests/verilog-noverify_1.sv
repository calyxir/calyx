...
wire _guard191 = invoke0_done_out;
wire _guard192 = ~_guard191;
wire _guard193 = fsm1_out == 3'd0;
wire _guard194 = _guard192 & _guard193;
wire _guard195 = tdcc1_go_out;
wire _guard196 = _guard194 & _guard195;
wire _guard197 = pd_out;
wire _guard198 = tdcc_done_out;
wire _guard199 = _guard197 | _guard198;
wire _guard200 = ~_guard199;
wire _guard201 = par0_go_out;
...
assign invoke0_go_in = _guard196;
assign tdcc_go_in = _guard202;
...
assign early_reset_cond000_go_in = _guard227;
assign tdcc0_go_in = _guard233;
assign par0_done_in = _guard236;
assign beg_spl_upd1_go_in = _guard242;
assign invoke0_done_in = i0_done;
assign invoke1_go_in = _guard248;
...
assign pd0_in =
  ...
  _guard295 ? 1'd0 :
  1'd0;
assign upd2_go_in = _guard301;
assign tdcc_done_in = _guard302;
...
// COMPONENT START: m_ar_channel_32_8
logic arvalid_in;
...
// COMPONENT END: m_ar_channel_32_8
endmodule
module m_aw_channel_32_8(
  input logic ARESETn,
  input logic AWREADY,
  input logic go,
  input logic clk,
...
// COMPONENT START: m_aw_channel_32_8
logic awvalid_in;
...
// COMPONENT END: m_aw_channel_32_8
endmodule
module m_read_channel_32_8(
  input logic ARESETn,
  input logic RVALID,
  input logic RLAST,
...
// COMPONENT START: m_read_channel_32_8
logic rready_in;
...
wire _guard230 = _guard228 | _guard229;
wire _guard231 = par0_done_out;
wire _guard232 = ~_guard231;
wire _guard233 = fsm_out == 3'd4;
wire _guard234 = _guard232 & _guard233;
wire _guard235 = tdcc_go_out;
wire _guard236 = _guard234 & _guard235;
wire _guard237 = service_read_transfer_done_out;
wire _guard238 = ~_guard237;
wire _guard239 = fsm_out == 3'd3;
wire _guard240 = _guard238 & _guard239;
...
assign rready_in =
  ...
  _guard230 ? 1'd0 :
  'x;
assign par0_go_in = _guard236;
assign service_read_transfer_go_in = _guard242;
// COMPONENT END: m_read_channel_32_8
endmodule
module m_write_channel_32_8(
  input logic ARESETn,
  input logic WREADY,
  input logic go,
  input logic clk,
...
// COMPONENT START: m_write_channel_32_8
logic wvalid_in;
...
wire _guard121 = invoke2_done_out;
wire _guard122 = ~_guard121;
wire _guard123 = fsm_out == 3'd2;
wire _guard124 = _guard122 & _guard123;
wire _guard125 = tdcc_go_out;
wire _guard126 = _guard124 & _guard125;
wire _guard127 = pd_out;
wire _guard128 = wrapper_early_reset_static_par_thread_done_out;
wire _guard129 = _guard127 | _guard128;
wire _guard130 = ~_guard129;
wire _guard131 = par0_go_out;
...
assign invoke2_go_in = _guard126;
assign wrapper_early_reset_static_par_thread_go_in = _guard132;
assign curr_addr_axi_incr_4_2_group_done_in = curr_addr_axi_done;
assign curr_addr_axi_incr_4_2_left = curr_addr_axi_out;
assign curr_addr_axi_incr_4_2_right = 64'd4;
...
// COMPONENT END: m_write_channel_32_8
endmodule
module m_bresp_channel_32_8(
  input logic ARESETn,
  input logic BVALID,
  input logic go,
  input logic clk,
...
// COMPONENT START: m_bresp_channel_32_8
logic bready_in;
...
// COMPONENT END: m_bresp_channel_32_8
endmodule
module Toplevel(
  input logic ap_clk,
  input logic m_axi_A0_ARESETn,
  input logic m_axi_A0_ARREADY,
  input logic m_axi_A0_RVALID,
  input logic m_axi_A0_RLAST,
  input logic [31:0] m_axi_A0_RDATA,
  input logic [1:0] m_axi_A0_RRESP,
  input logic m_axi_A0_AWREADY,
  input logic [1:0] m_axi_A0_WRESP,
  input logic m_axi_A0_WREADY,
  input logic m_axi_A0_BVALID,
  input logic [1:0] m_axi_A0_BRESP,
  input logic m_axi_A0_RID,
  input logic m_axi_B0_ARESETn,
  input logic m_axi_B0_ARREADY,
  input logic m_axi_B0_RVALID,
  input logic m_axi_B0_RLAST,
  input logic [31:0] m_axi_B0_RDATA,
  input logic [1:0] m_axi_B0_RRESP,
  input logic m_axi_B0_AWREADY,
  input logic [1:0] m_axi_B0_WRESP,
  input logic m_axi_B0_WREADY,
  input logic m_axi_B0_BVALID,
  input logic [1:0] m_axi_B0_BRESP,
  input logic m_axi_B0_RID,
  input logic m_axi_Sum0_ARESETn,
  input logic m_axi_Sum0_ARREADY,
  input logic m_axi_Sum0_RVALID,
  input logic m_axi_Sum0_RLAST,
  input logic [31:0] m_axi_Sum0_RDATA,
  input logic [1:0] m_axi_Sum0_RRESP,
  input logic m_axi_Sum0_AWREADY,
  input logic [1:0] m_axi_Sum0_WRESP,
  input logic m_axi_Sum0_WREADY,
  input logic m_axi_Sum0_BVALID,
  input logic [1:0] m_axi_Sum0_BRESP,
  input logic m_axi_Sum0_RID,
  input logic go,
  input logic reset,
  output logic m_axi_A0_ARVALID,
  output logic [63:0] m_axi_A0_ARADDR,
  output logic [2:0] m_axi_A0_ARSIZE,
  output logic [7:0] m_axi_A0_ARLEN,
  output logic [1:0] m_axi_A0_ARBURST,
  output logic m_axi_A0_RREADY,
  output logic m_axi_A0_AWVALID,
  output logic [63:0] m_axi_A0_AWADDR,
  output logic [2:0] m_axi_A0_AWSIZE,
  output logic [7:0] m_axi_A0_AWLEN,
  output logic [1:0] m_axi_A0_AWBURST,
  output logic [2:0] m_axi_A0_AWPROT,
  output logic m_axi_A0_WVALID,
  output logic m_axi_A0_WLAST,
  output logic [31:0] m_axi_A0_WDATA,
  output logic m_axi_A0_BREADY,
  output logic m_axi_A0_ARID,
  output logic m_axi_A0_AWID,
  output logic m_axi_A0_WID,
  output logic m_axi_A0_BID,
  output logic m_axi_B0_ARVALID,
  output logic [63:0] m_axi_B0_ARADDR,
  output logic [2:0] m_axi_B0_ARSIZE,
  output logic [7:0] m_axi_B0_ARLEN,
  output logic [1:0] m_axi_B0_ARBURST,
  output logic m_axi_B0_RREADY,
  output logic m_axi_B0_AWVALID,
  output logic [63:0] m_axi_B0_AWADDR,
  output logic [2:0] m_axi_B0_AWSIZE,
  output logic [7:0] m_axi_B0_AWLEN,
  output logic [1:0] m_axi_B0_AWBURST,
  output logic [2:0] m_axi_B0_AWPROT,
  output logic m_axi_B0_WVALID,
  output logic m_axi_B0_WLAST,
  output logic [31:0] m_axi_B0_WDATA,
  output logic m_axi_B0_BREADY,
  output logic m_axi_B0_ARID,
  output logic m_axi_B0_AWID,
  output logic m_axi_B0_WID,
  output logic m_axi_B0_BID,
  output logic m_axi_Sum0_ARVALID,
  output logic [63:0] m_axi_Sum0_ARADDR,
  output logic [2:0] m_axi_Sum0_ARSIZE,
  output logic [7:0] m_axi_Sum0_ARLEN,
  output logic [1:0] m_axi_Sum0_ARBURST,
  output logic m_axi_Sum0_RREADY,
  output logic m_axi_Sum0_AWVALID,
  output logic [63:0] m_axi_Sum0_AWADDR,
  output logic [2:0] m_axi_Sum0_AWSIZE,
  output logic [7:0] m_axi_Sum0_AWLEN,
  output logic [1:0] m_axi_Sum0_AWBURST,
  output logic [2:0] m_axi_Sum0_AWPROT,
  output logic m_axi_Sum0_WVALID,
  output logic m_axi_Sum0_WLAST,
  output logic [31:0] m_axi_Sum0_WDATA,
  output logic m_axi_Sum0_BREADY,
  output logic m_axi_Sum0_ARID,
  output logic m_axi_Sum0_AWID,
  output logic m_axi_Sum0_WID,
  output logic m_axi_Sum0_BID,
  output logic done
);
// COMPONENT START: Toplevel
...
m_ar_channel_32_8 ar_channel_A0 (
...
m_read_channel_32_8 read_channel_A0 (
...
m_aw_channel_32_8 aw_channel_A0 (
...
m_write_channel_32_8 write_channel_A0 (
...
m_bresp_channel_32_8 bresp_channel_A0 (
...
m_ar_channel_32_8 ar_channel_B0 (
...
m_read_channel_32_8 read_channel_B0 (
...
m_aw_channel_32_8 aw_channel_B0 (
...
m_write_channel_32_8 write_channel_B0 (
...
m_bresp_channel_32_8 bresp_channel_B0 (
...
m_ar_channel_32_8 ar_channel_Sum0 (
...
m_read_channel_32_8 read_channel_Sum0 (
...
m_aw_channel_32_8 aw_channel_Sum0 (
...
m_write_channel_32_8 write_channel_Sum0 (
...
m_bresp_channel_32_8 bresp_channel_Sum0 (
...
wire _guard26 = invoke6_go_out;
wire _guard27 = invoke16_go_out;
wire _guard28 = invoke8_go_out;
wire _guard29 = invoke16_go_out;
wire _guard30 = invoke9_go_out;
wire _guard31 = invoke19_go_out;
wire _guard32 = invoke10_go_out;
wire _guard33 = invoke11_go_out;
wire _guard34 = invoke8_go_out;
wire _guard35 = invoke10_go_out;
wire _guard36 = invoke22_go_out;
wire _guard37 = invoke22_go_out;
wire _guard38 = invoke8_go_out;
wire _guard39 = invoke23_go_out;
wire _guard40 = invoke17_go_out;
wire _guard41 = invoke19_go_out;
wire _guard42 = invoke19_go_out;
wire _guard43 = invoke20_go_out;
wire _guard44 = invoke10_go_out;
wire _guard45 = invoke23_go_out;
wire _guard46 = invoke19_go_out;
wire _guard47 = invoke6_go_out;
wire _guard48 = invoke7_go_out;
wire _guard49 = invoke19_go_out;
wire _guard50 = invoke16_go_out;
wire _guard51 = invoke16_go_out;
wire _guard52 = invoke20_go_out;
wire _guard53 = invoke22_go_out;
wire _guard54 = invoke24_go_out;
wire _guard55 = invoke6_go_out;
wire _guard56 = invoke17_go_out;
wire _guard57 = invoke8_go_out;
wire _guard58 = invoke6_go_out;
wire _guard59 = invoke6_go_out;
wire _guard60 = invoke16_go_out;
wire _guard61 = invoke8_go_out;
wire _guard62 = invoke10_go_out;
wire _guard63 = invoke22_go_out;
wire _guard64 = invoke22_go_out;
wire _guard65 = invoke17_go_out;
wire _guard66 = invoke18_go_out;
wire _guard67 = invoke23_go_out;
wire _guard68 = invoke16_go_out;
wire _guard69 = invoke21_go_out;
wire _guard70 = invoke19_go_out;
wire _guard71 = invoke20_go_out;
wire _guard72 = invoke10_go_out;
wire _guard73 = invoke22_go_out;
...
wire _guard247 = wrapper_early_reset_static_par_thread_done_out;
wire _guard248 = ~_guard247;
wire _guard249 = fsm5_out == 3'd0;
wire _guard250 = _guard248 & _guard249;
wire _guard251 = tdcc5_go_out;
...
wire _guard595 = fsm1_out == 2'd2;
wire _guard596 = wrapper_early_reset_static_par_thread_go_out;
wire _guard597 = signal_reg0_out;
...
wire _guard731 = pd1_out;
wire _guard732 = tdcc1_done_out;
wire _guard733 = _guard731 | _guard732;
wire _guard734 = ~_guard733;
wire _guard735 = par0_go_out;
wire _guard736 = _guard734 & _guard735;
wire _guard737 = invoke6_done_out;
wire _guard738 = ~_guard737;
wire _guard739 = fsm_out == 2'd0;
wire _guard740 = _guard738 & _guard739;
wire _guard741 = tdcc_go_out;
wire _guard742 = _guard740 & _guard741;
wire _guard743 = invoke24_done_out;
wire _guard744 = ~_guard743;
wire _guard745 = fsm4_out == 2'd2;
wire _guard746 = _guard744 & _guard745;
wire _guard747 = tdcc4_go_out;
...
assign m_axi_A0_ARBURST =
  _guard26 ? ar_channel_A0_ARBURST :
  2'd0;
assign m_axi_A0_AWSIZE =
  _guard27 ? aw_channel_A0_AWSIZE :
  3'd0;
assign m_axi_A0_ARID = 1'd0;
assign m_axi_B0_ARLEN =
  _guard28 ? ar_channel_B0_ARLEN :
  8'd0;
assign m_axi_B0_ARID = 1'd0;
assign m_axi_Sum0_BID = 1'd0;
assign m_axi_A0_AWBURST =
  _guard29 ? aw_channel_A0_AWBURST :
  2'd0;
assign m_axi_B0_RREADY =
  _guard30 ? read_channel_B0_RREADY :
  1'd0;
assign m_axi_B0_AWADDR =
  _guard31 ? aw_channel_B0_AWADDR :
  64'd0;
assign m_axi_Sum0_ARVALID =
  _guard32 ? ar_channel_Sum0_ARVALID :
  1'd0;
assign m_axi_Sum0_RREADY =
  _guard33 ? read_channel_Sum0_RREADY :
  1'd0;
assign m_axi_A0_WID = 1'd0;
assign m_axi_B0_ARADDR =
  _guard34 ? ar_channel_B0_ARADDR :
  64'd0;
assign m_axi_Sum0_ARBURST =
  _guard35 ? ar_channel_Sum0_ARBURST :
  2'd0;
assign m_axi_Sum0_AWLEN =
  _guard36 ? aw_channel_Sum0_AWLEN :
  8'd0;
assign m_axi_Sum0_AWBURST =
  _guard37 ? aw_channel_Sum0_AWBURST :
  2'd0;
assign m_axi_Sum0_WID = 1'd0;
assign m_axi_A0_BID = 1'd0;
assign m_axi_B0_ARVALID =
  _guard38 ? ar_channel_B0_ARVALID :
  1'd0;
assign m_axi_Sum0_WDATA =
  _guard39 ? write_channel_Sum0_WDATA :
  32'd0;
assign m_axi_A0_WLAST =
  _guard40 ? write_channel_A0_WLAST :
  1'd0;
assign m_axi_B0_AWLEN =
  _guard41 ? aw_channel_B0_AWLEN :
  8'd0;
assign m_axi_B0_AWBURST =
  _guard42 ? aw_channel_B0_AWBURST :
  2'd0;
assign m_axi_B0_WDATA =
  _guard43 ? write_channel_B0_WDATA :
  32'd0;
assign m_axi_Sum0_ARADDR =
  _guard44 ? ar_channel_Sum0_ARADDR :
  64'd0;
assign m_axi_Sum0_WLAST =
  _guard45 ? write_channel_Sum0_WLAST :
  1'd0;
assign m_axi_B0_AWPROT =
  _guard46 ? aw_channel_B0_AWPROT :
  3'd0;
assign m_axi_B0_AWID = 1'd0;
assign m_axi_A0_ARVALID =
  _guard47 ? ar_channel_A0_ARVALID :
  1'd0;
assign m_axi_A0_RREADY =
  _guard48 ? read_channel_A0_RREADY :
  1'd0;
assign m_axi_A0_AWID = 1'd0;
assign m_axi_B0_AWSIZE =
  _guard49 ? aw_channel_B0_AWSIZE :
  3'd0;
assign m_axi_A0_AWVALID =
  _guard50 ? aw_channel_A0_AWVALID :
  1'd0;
assign m_axi_A0_AWLEN =
  _guard51 ? aw_channel_A0_AWLEN :
  8'd0;
assign m_axi_B0_WLAST =
  _guard52 ? write_channel_B0_WLAST :
  1'd0;
assign m_axi_Sum0_AWVALID =
  _guard53 ? aw_channel_Sum0_AWVALID :
  1'd0;
assign m_axi_Sum0_BREADY =
  _guard54 ? bresp_channel_Sum0_BREADY :
  1'd0;
assign m_axi_Sum0_ARID = 1'd0;
assign m_axi_Sum0_AWID = 1'd0;
assign m_axi_A0_ARADDR =
  _guard55 ? ar_channel_A0_ARADDR :
  64'd0;
assign m_axi_A0_WVALID =
  _guard56 ? write_channel_A0_WVALID :
  1'd0;
assign m_axi_B0_ARBURST =
  _guard57 ? ar_channel_B0_ARBURST :
  2'd0;
assign m_axi_A0_ARSIZE =
  _guard58 ? ar_channel_A0_ARSIZE :
  3'd0;
assign m_axi_A0_ARLEN =
  _guard59 ? ar_channel_A0_ARLEN :
  8'd0;
assign m_axi_A0_AWPROT =
  _guard60 ? aw_channel_A0_AWPROT :
  3'd0;
assign m_axi_B0_ARSIZE =
  _guard61 ? ar_channel_B0_ARSIZE :
  3'd0;
assign m_axi_Sum0_ARSIZE =
  _guard62 ? ar_channel_Sum0_ARSIZE :
  3'd0;
assign m_axi_Sum0_AWADDR =
  _guard63 ? aw_channel_Sum0_AWADDR :
  64'd0;
assign m_axi_Sum0_AWSIZE =
  _guard64 ? aw_channel_Sum0_AWSIZE :
  3'd0;
assign m_axi_A0_WDATA =
  _guard65 ? write_channel_A0_WDATA :
  32'd0;
assign m_axi_A0_BREADY =
  _guard66 ? bresp_channel_A0_BREADY :
  1'd0;
assign m_axi_Sum0_WVALID =
  _guard67 ? write_channel_Sum0_WVALID :
  1'd0;
assign m_axi_A0_AWADDR =
  _guard68 ? aw_channel_A0_AWADDR :
  64'd0;
assign m_axi_B0_BREADY =
  _guard69 ? bresp_channel_B0_BREADY :
  1'd0;
assign m_axi_B0_WID = 1'd0;
assign m_axi_B0_AWVALID =
  _guard70 ? aw_channel_B0_AWVALID :
  1'd0;
assign m_axi_B0_WVALID =
  _guard71 ? write_channel_B0_WVALID :
  1'd0;
assign m_axi_B0_BID = 1'd0;
assign m_axi_Sum0_ARLEN =
  _guard72 ? ar_channel_Sum0_ARLEN :
  8'd0;
assign m_axi_Sum0_AWPROT =
  _guard73 ? aw_channel_Sum0_AWPROT :
  3'd0;
assign fsm_write_en = _guard86;
...
assign fsm5_in =
  ...
  _guard245 ? 3'd3 :
  3'd0;
assign tdcc0_done_in = _guard246;
assign wrapper_early_reset_static_par_thread_go_in = _guard252;
...
assign ar_channel_Sum0_ARREADY =
  _guard400 ? m_axi_Sum0_ARREADY :
  1'd0;
assign ar_channel_Sum0_ARESETn =
  _guard401 ? m_axi_Sum0_ARESETn :
  1'd0;
...
assign aw_channel_B0_go = _guard439;
assign aw_channel_B0_AWREADY =
  _guard440 ? m_axi_B0_AWREADY :
  1'd0;
assign aw_channel_B0_ARESETn =
  _guard441 ? m_axi_B0_ARESETn :
  1'd0;
...
assign fsm2_in =
  ...
  _guard500 ? 2'd2 :
  2'd0;
assign tdcc0_go_in = _guard506;
assign invoke8_go_in = _guard512;
...
assign ar_channel_A0_ARREADY =
  _guard515 ? m_axi_A0_ARREADY :
  1'd0;
assign ar_channel_A0_ARESETn =
  _guard516 ? m_axi_A0_ARESETn :
  1'd0;
...
assign aw_channel_A0_go = _guard518;
assign aw_channel_A0_AWREADY =
  _guard519 ? m_axi_A0_AWREADY :
  1'd0;
assign aw_channel_A0_ARESETn =
  _guard520 ? m_axi_A0_ARESETn :
  1'd0;
...
assign ar_channel_B0_ARREADY =
  _guard578 ? m_axi_B0_ARREADY :
  1'd0;
assign ar_channel_B0_ARESETn =
  _guard579 ? m_axi_B0_ARESETn :
  1'd0;
...
assign signal_reg_in =
  ...
  _guard594 ? 1'd0 :
  1'd0;
assign tdcc1_done_in = _guard595;
assign early_reset_static_par_thread_go_in = _guard596;
assign wrapper_early_reset_static_par_thread0_done_in = _guard597;
...
assign aw_channel_Sum0_go = _guard693;
assign aw_channel_Sum0_AWREADY =
  _guard694 ? m_axi_Sum0_AWREADY :
  1'd0;
assign aw_channel_Sum0_ARESETn =
  _guard695 ? m_axi_Sum0_ARESETn :
  1'd0;
assign write_channel_Sum0_WREADY =
  _guard696 ? m_axi_Sum0_WREADY :
  1'd0;
...
assign curr_addr_internal_mem_Sum0_in =
  ...
  _guard730 ? 3'd0 :
  'x;
assign tdcc1_go_in = _guard736;
assign early_reset_static_par_thread_done_in = ud_out;
assign invoke6_go_in = _guard742;
assign invoke24_go_in = _guard748;

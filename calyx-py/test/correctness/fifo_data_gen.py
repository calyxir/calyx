...
def dump_json():
    ...
    - The `commands` array has MAX_CMDS items, which are 0, 1, or 2.
    - The `values` array has MAX_CMDS items: random values between 0 and 100.
    - The `ans_mem` array has ANS_MEM_LEN items, all zeroes.

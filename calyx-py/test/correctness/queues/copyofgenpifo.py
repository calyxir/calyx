        ...
        cb.if_with(
            ...
            cb.if_with(
                ...
                [  # The queue is not empty. Proceed.
                    lower_err,
                    [
                        handles, # Only invoke the subqueue that is hot, but we must loop
                                 # through to check all of them.
                        # Our next step depends on whether `fifos[hot]`
                        # raised the error flag.
                        # We can check these cases in parallel.
                        cb.if_with(
                            err_neq_0, # there is an error
        ...
        cb.if_with(
            ...
            cb.if_with(
                ...
                [  # The queue is not full. Proceed.
                    ...
                    cb.while_with(i_lt_n, [infer_flow_grp, upd_divider]),  # TODO
                    handles,
                    cb.if_with(
                        err_eq_0,

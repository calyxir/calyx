...
def insert_pifo(
   ...
   div_lt_val = pifo.lt_use(divider.out, value)
   ...
   with pifo.group("upd_hot_flow") as upd_hot_flow:
       div_reg.left = flow.out
       div_reg.right = bound_val.out
       div_reg.go = cb.HI
       hot_flow.in_ = div_reg.out_quotient
       hot_flow.write_en = div_reg.done
       upd_hot_flow.done = hot_flow.done
       ...
       cb.if_with(
           ...
           cb.if_with(
               ...
               [  # The queue is not full. Proceed.
                   ...
                   cb.while_with(div_lt_val, [upd_divider, infer_flow_grp]),

...
if __name__ == "__main__":
    ...
    # Our PIFO is simple: it just orchestrates n FIFOs, in this case 3. It takes
    # in a list of boundaries of length n (in this case 2)
    pifo = queues.NPifo(3, [133, 266, 400], len)

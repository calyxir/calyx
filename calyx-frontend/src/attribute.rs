...
impl Attribute {
    ...
    const fn inline_idx(&self) -> Option<u16> {
        match self {
            ...
            Attribute::Generated => Some(9),
            Attribute::NewFSM => Some(10),
            Attribute::Inline => Some(11),
            Attribute::DEAD => Some(12),
            _ => None,
        }
    }

    pub(super) fn rev_idx(idx: u16) -> Self {
        match idx {
            0 => Attribute::TopLevel,
            1 => Attribute::External,
            2 => Attribute::NoInterface,
            3 => Attribute::Reset,
            4 => Attribute::Clk,
            5 => Attribute::Stable,
            6 => Attribute::Data,
            7 => Attribute::Share,
            8 => Attribute::StateShare,
            9 => Attribute::Generated,
            10 => Attribute::NewFSM,
            11 => Attribute::Inline,
            12 => Attribute::DEAD,
            _ => unreachable!("Unknown inline index"),
        }
    }
...
impl InlineAttributes {
    ...
    pub(super) fn iter(&self) -> impl Iterator<Item = Attribute> + '_ {
        (0..14).filter_map(move |idx| {
            if self.attrs & (1 << idx) != 0 {
                Some(Attribute::rev_idx(idx))
            } else {
                None
            }
        })

...
impl Backend for XilinxInterfaceBackend {
    ...
    fn emit(
        ...
        super::axi::axi(&mut module, 12, 32, &["A", "B"]);
...
//         "AWREADY".into(),
//         v::Expr::new_eq("wstate".into(), "WRIDLE".into()),
//     ));
//     // ready to receive data when fsm is in WRDATA
//     // assign WREADY = (wstate == WRDATA);
//     module.add_stmt(v::Parallel::Assign(
//         "WREADY".into(),
//         v::Expr::new_eq("wstate".into(), "WRDATA".into()),
//     ));
//     // assign BRESP = 2'b00;
//     module.add_stmt(v::Parallel::Assign(
//         "BRESP".into(),
...
//     module.add_stmt(v::Parallel::Assign(
//         "BVALID".into(),
//         v::Expr::new_eq("wstate".into(), "WRRESP".into()),
//     ));
...
//     module.add_stmt(v::Parallel::Assign(
//         "ARREADY".into(),
//         v::Expr::new_eq("rstate".into(), "RDIDLE".into()),
//     ));
//     // ready to receive data when fsm is in WRDATA
//     // assign RDATA = rdata;

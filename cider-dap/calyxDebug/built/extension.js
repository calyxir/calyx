...
var CiderDebugAdapterDescriptorFactory = /** @class */ (function () {
    function CiderDebugAdapterDescriptorFactory() {
    }
    CiderDebugAdapterDescriptorFactory.prototype.createDebugAdapterDescriptor = function (_session, _executable) {
        // Use the DebugAdapterExecutable as the debug adapter descriptor
        console.log("inside adapter factory");
        return new vscode.DebugAdapterExecutable(vscode.workspace.getConfiguration("cider-dap").path);
    };
    return CiderDebugAdapterDescriptorFactory;
}());
function activate(context) {
    ...
    // );
    context.subscriptions.push(vscode.debug.registerDebugAdapterDescriptorFactory("cider-dap", new CiderDebugAdapterDescriptorFactory()));

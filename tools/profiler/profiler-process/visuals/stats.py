...
def calc(fully_qualified_par_name, active_cycles, trace, main_shortname):
...
def write_group_stats(trace, out_dir):
    group_to_stats = {}  # group --> {"num-times-active", "active-cycles"}
    pass

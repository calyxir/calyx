...
- `inductive`: This planner is based off the algorithm specified in [this latte paper](https://capra.cs.cornell.edu/latte26/paper/latte26-final30.pdf). It should be fast enough (polynomial time at the least) and correct for ops with multiple inputs and outputs.

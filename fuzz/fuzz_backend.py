...
if __name__ == "__main__":
    ...
    if parser.parse_args().compare_files:
        print("we are comparing files!")
        do_fuzz_file(arg_lst[0][0], arg_lst[0][1], arg_lst[0][2], arg_lst[0][3], int(arg_lst[0][4]))
    elif parser.parse_args().compare_backend:
        do_fuzz_backend(arg_lst[0][2], arg_lst[0][0], arg_lst[0][1], arg_lst[0][3], int(arg_lst[0][4]))
